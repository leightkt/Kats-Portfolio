...
function Contact () {
    return(
        <section className="contact-container">
            ...
            <a href="mailto:leightkt@gmail.com"><img className="contact-icon gmail" src={gmail} alt="gmail logo" /></a>
            ...
            <a href="https://kat-leight.medium.com/"><img className="contact-icon medium" src={medium} alt="medium icon"/></a>
